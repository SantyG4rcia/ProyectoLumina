 ...
 * @author USUARIO
 */
public class vistaFiltrarEmpleados extends javax.swing.JFrame {

    /**
     * Creates new form vistaFiltrarEmpleados
     */
    public vistaFiltrarEmpleados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnBuscarClientes.setText("Buscar empleado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaFiltrarEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaFiltrarEmpleados().setVisible(true);
            }
        });
    }
